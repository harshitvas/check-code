  ...
  return (
    <div className="max-w-md mx-auto mt-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <label htmlFor="biology" className="flex font-medium flex-start">
            Biology<span className="text-red-500">*</span>
          </label>
          <input
            type="text"
            id="biology"
            name="bioMarks"
            value={props.formData.bioMarks}
            onKeyPress={(e) => {
              const regex = /^(?:\d{0,3}(?:\.\d{0,2})?)$/;
              const currentValue = e.target.value;
              const nextValue = currentValue + e.key;
